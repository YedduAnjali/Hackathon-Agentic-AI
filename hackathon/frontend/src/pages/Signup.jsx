    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center p-4">
      ...
      >
        ...
        <motion.div
          ...
          className="bg-slate-800 rounded-lg shadow-2xl p-8 border border-purple-500/20"
        >
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <motion.button
              ...
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white font-semibold py-2 px-4 rounded-lg transition disabled:opacity-50 disabled:cursor-not-allowed mt-6"
            >
          ...
          >
            <Link
              to="/login"
              className="w-full block text-center bg-slate-700 hover:bg-slate-600 text-white font-semibold py-2 px-4 rounded-lg transition"
            >
              Sign In
            </Link>
          </motion.div>
        ...
        >
          Secure account creation with bcrypt encryption
        </motion.p>
      </motion.div>
    </div>
  );
